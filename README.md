# 🎵 Bmbtech-api - Frontend

# Visit Bmbtech-api Official 
- https://Bmbtech-site.vercel.app

# This Development Version
- https://bmbtech-site.vercel.app

Modern web frontend for Bmbtech-api media extraction and download flow. Built with **Next.js**, **TypeScript**, and **Tailwind CSS**.
...
- This project is frontend runtime; backend service is in sibling project `Bmbtech-api`.
