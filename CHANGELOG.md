...
All notable changes to Bmbtech-api will be documented in this file.
...
- Aligned frontend docs/env guidance to signed `/api/web/*` runtime behavior and Bmbtech-api-API naming.
...
- Added rich Discord embed format for feedback submissions (`Bmbtech-api Feedback`) with structured Name/Datetime/Comment fields.
...
- Added accent color presets in Basic settings (`New Color`, `Old Bmbtech-api`, and preset variants) with runtime apply.
...
### 🚀 Project Revived New Bmbtech-api 2.1 
...
## [0x1] - 2026-12-30 Project History

### All changelog History can be found here > old_changelog.md

## Version History
- [2.0.0] - 2026-12-30 > New Platforms (yt-dlp + gallery-dl based)
- [1.9.0] - 2026-12-28 > Performance Improvements 
- [1.7.0] - 2026-12-25 > Telegram Bot Integration 
- [1.6.0] - 2026-12-25 > Rebranding: XTFetch → Bmbtech-api 
- [1.4.0] - December 23, 2026
- [1.3.0_v0] - December 23, 2026  
- [1.2.0] - December 21, 2026 
- [1.0.5] - December 20, 2026 
- [1.0.4] - December 15, 2026
- [1.0.3] - December 10, 2026 
- [1.0.2] - December 8, 2026 
- [1.0.1] - December 5, 2026 
- [1.0.0] - November 25, 2026 (Initial Release XTFetch)
