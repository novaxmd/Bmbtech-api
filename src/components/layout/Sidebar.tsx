                ...
                <div className="flex items-center justify-between px-3 py-3">
                    ...
                    <div className="flex items-center gap-2">
                        ...
                        <Link href="/" className="flex items-center gap-2">
                            <img src="/icon.png" alt="Bmbtech" className="w-8 h-8 rounded-lg" />
                            <div>
                                <h1 className="text-sm font-bold gradient-text">Bmbtech</h1>
        ...
        <div className="flex flex-col h-full">
            ...
            <div className="p-5 border-b border-[var(--border-color)]">
                ...
                >
                    ...
                    />
                    <div>
                        <h1 className="text-lg font-bold gradient-text">Bmbtech</h1>
                        ...
                        {accountOpen && (
                            ...
                            >
                                ...
                                >
                                    ...
                                    <span>{tSidebar('aboutBmbtech')}</span>
                                </Link>
                            </motion.div>
                        )}
                    </AnimatePresence>
