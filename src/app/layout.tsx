...
export const metadata: Metadata = {
  ...
  title: "Bmbtech - Free Social Media Video Downloader | Facebook, Instagram, TikTok, Twitter",
  ...
  keywords: [
    "Bmbtech", "down aria", "Bmbtech downloader", "social media downloader", "video downloader",
  ...
  openGraph: {
    title: "Bmbtech - Free Social Media Video Downloader",
  ...
  twitter: {
    card: "summary",
    title: "Bmbtech - Free Social Media Downloader",
      ...
      <head>
        ...
        <script
          dangerouslySetInnerHTML={{
            __html: `(function(){try{var t=localStorage.getItem('Bmbtech-theme');if(t==='auto'||!t){var m=window.matchMedia('(prefers-color-scheme:dark)').matches;t=m?'dark':'light'}if(t)document.documentElement.className=t==='dark'?'theme-dark dark':t==='solarized'?'theme-solarized':'theme-light'}catch(e){}})()`,
          }}
        />
        <StructuredData />
      </head>
