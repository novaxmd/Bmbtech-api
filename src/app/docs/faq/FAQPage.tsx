...
const faqs: { category: string; items: FAQItem[] }[] = [
    {
        category: 'General',
        items: [
            { question: 'What is Bmbtech?', answer: 'Bmbtech is a social media downloader built with a Next.js frontend and a Go backend (Bmbtech-API).' },
            { question: 'Is Bmbtech free?', answer: 'Yes, core usage is free. Request limits and service behavior still follow backend policy.' },
                ...
                <div className="max-w-4xl mx-auto">
                    ...
                    <div className="space-y-6">
                        <motion.div initial={{ opacity: 0, y: 20 }} animate={{ opacity: 1, y: 0 }}>
                            ...
                            <p className="text-[var(--text-muted)] text-sm leading-relaxed">Common user and integration questions for current Bmbtech runtime behavior.</p>
                        </motion.div>
