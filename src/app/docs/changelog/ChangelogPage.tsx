 ...
 * as collapsible cards per version — adapted from Bmbtech-api2.
 *
                ...
                <div className="max-w-4xl mx-auto">
                    ...
                    <div className="space-y-6">
                        ...
                        <div className="text-center text-sm text-[var(--text-muted)] py-4">
                            Full changelog in{' '}
                            <a href="https://github.com/novaxmd/Bmbtech-api/blob/main/CHANGELOG.md" target="_blank" rel="noopener noreferrer" className="text-[var(--accent-primary)] hover:underline">
                                CHANGELOG.md
                            </a>
                        </div>
                    </div>
