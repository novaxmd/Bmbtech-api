...
const quickLinks = [
    ...
    { href: '/about', icon: Info, title: 'About Bmbtech', desc: 'Project story, feature overview, and ecosystem links' },
                    ...
                    <div className="space-y-6">
                        ...
                        >
                            <h1 className="text-2xl sm:text-3xl font-bold mb-3 leading-tight">
                                <span className="gradient-text">Bmbtech</span> Documentation
                            </h1>
                            <p className="text-[var(--text-muted)] max-w-2xl mx-auto text-sm leading-relaxed">
                                Learn how to use Bmbtech to download videos from social media platforms.
