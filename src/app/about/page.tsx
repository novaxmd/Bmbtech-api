 ...
 *
 * Modern, clean design showcasing Bmbtech features and supported platforms.
 */
        ...
        <div className="max-w-4xl mx-auto">
          <motion.div initial={{ opacity: 0, y: 20 }} animate={{ opacity: 1, y: 0 }} className="text-center mb-8">
            <h1 className="text-3xl sm:text-4xl font-bold mb-3">
              {t('title')} <span className="gradient-text">Bmbtech</span>
            </h1>
              ...
              <div className="space-y-2">
                ...
                >
                  ...
                  <div className="flex-1 min-w-0">
                    <p className="text-sm font-medium text-[var(--text-primary)]">{tPage('projects.Bmbtech.title')}</p>
                    <p className="text-xs text-[var(--text-muted)] leading-relaxed">
                      {tPage('projects.Bmbtech.description')}
                    </p>
                  </div>
